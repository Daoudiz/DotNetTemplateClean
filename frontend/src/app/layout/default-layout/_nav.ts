...
export const navItems: INavData[] = [
 ...
 /* {
  ...
  
  {
    ...
    name: 'Référentiel',
    class: 'mt-auto',
    attributes: { role: 'Admin' } // on marque cette section pour les Admins uniquement
  },
  {
    name: 'Organisation',
    url: '/organisation', // Segment de base défini dans app.routes.ts
  ...
  },
  {
    ...
    attributes: { role: 'Admin' } // On marque cet item pour les Admins uniquement
  }
